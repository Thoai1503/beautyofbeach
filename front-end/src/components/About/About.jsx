...
import { faEnvelope, faMapMarked, faUser } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <>
            ...
            <div className="container" style={{ clear: "both" }}>
                <div ><h1 className="textintroduce">Founder members</h1></div>
                <div className="hau one-div">
                    ...
                    <p className="texthau text">
                        <h1 style={{ textAlign: "center", color: 'white' }} className="hauh1">
                            Hau Huynh
                        </h1>
                        <p
                            style={{
                ...
                <div className="thien one-div">
                    <img
                        src="https://images.pexels.com/photos/1666634/pexels-photo-1666634.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
                        alt=""
                        style={{ width: "1500px", height: "500px", filter: "blur(1.5px)" }}
                    />
                    <img
                    ...
                    />
                    <p className="textthien text">
                        <h1 style={{ textAlign: "left ", width: '500px', fontSize: '95px', }} className="thienh1">
                            Thien Le Quang
                        </h1>
                        <p
                            style={{
                        ...
                        >
                            We are pleased to introduce Thien Le Quang, an excellent student
                            of Aptech Training Center, who is currently participating in an
                            important project in the curriculum. Thien Le Quang's project
                            revolves around Object Sem 1, a challenging and potential field.
                            Through the implementation process, Thien Le Quang has
                            demonstrated his ability and eagerness to learn by applying the
                            knowledge he has learned into practice.
                        </p>
                    </p>
                </div>
                <div className="hau one-div">
                    ...
                    <p className="texthau text">
                        <h1
                            style={{ textAlign: "center", fontSize: "91px", color: '#BBBBBB' }}
                            className="hauh1"
                        >
                            Thoai Vo Giang
                        </h1>
                ...
                <div className="thien one-div">
                    <img
                        src="https://images.pexels.com/photos/2457183/pexels-photo-2457183.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                        alt=""
                        style={{ width: "1500px", height: "500px", filter: "blur(0px)" }}
                    />
                    <img
                        src={Image4}
                        alt=""
                        className="overlay-image2 image2"
                        style={{
                            filter: "blur(1px)",
                            float: "left",
                            top: '100px'
                    ...
                    />
                    <p className="textthien text" style={{ maxWidth: '900px' }} >
                        <h1
                            style={{ textAlign: "center", fontSize: "90px", width: '500px   ' }}
                            className="thienh1"
                        >
                        ...
                        >
                            We would like to introduce our student Long Nguyen Le Hoang of
                            Aptech Training Center. Currently, Long Nguyen Le Hoang is
                            focusing on completing his project with the topic Object Sem 1.
                            With solid professional knowledge and constant creativity,
                            has demonstrated a serious spirit of learning and
                            working throughout the project. We believe that this project is
                            not only an important step in Long Nguyen Le Hoang's learning path
                            but will also bring many practical values ​​to the community.
                        </p>
                    </p>
                </div>
            </div>
            <div className="container imagebetween " style={{
                clear: 'both',
                marginTop: '40px'
            }}>
                <div class="card1">
                    <p>
                        <span>
                            <img src="https://images.pexels.com/photos/994605/pexels-photo-994605.jpeg" alt="" />
                        </span>
                    </p>
                    <p>
                        <span>
                            <img src="https://images.pexels.com/photos/189349/pexels-photo-189349.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                        </span>
                    </p>
                    <p>
                        <span>
                            <img src="https://images.pexels.com/photos/457881/pexels-photo-457881.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                        </span>
                    </p>
                    <p>
                        <span>
                    ...
                    <p>
                        <span>
                            <img src="https://images.pexels.com/photos/1450360/pexels-photo-1450360.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                        </span>
                    </p>
                    <p>
                        <span>
                            <img src="https://images.pexels.com/photos/635279/pexels-photo-635279.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                        </span>
                    </p>
                    <p>
                        <span>
                            <img src="https://images.pexels.com/photos/96377/pexels-photo-96377.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                        </span>
                    </p>
                    <p>
                        <span>
                            <img src="https://images.pexels.com/photos/1838556/pexels-photo-1838556.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                        </span>
                    </p>
                </div>
            </div >
